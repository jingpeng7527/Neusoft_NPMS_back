...
public class SalesLogController {
    ...
    public RespBean querySalesLog(String user_id, @DateTimeFormat(pattern="yyyy-MM-dd")LocalDate start_time, @DateTimeFormat(pattern="yyyy-MM-dd")LocalDate end_time){
        ...
        List<SalesLog> salesLogList = iSalesLogService.getByIdAndTime(user_id,start_time,end_time);
